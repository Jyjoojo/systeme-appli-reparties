...
- **Faible couplage** : les tâches manipulent uniquement les interfaces `Broker` et `Channel`, sans dépendre de leur implémentation concrète.
- **Synchronisation explicite** : les opérations bloquantes et le modèle lecteur-écrivain garantissent une communication sûre entre plusieurs tâches concurrentes.
